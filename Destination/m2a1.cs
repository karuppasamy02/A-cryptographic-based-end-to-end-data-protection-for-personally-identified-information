...
{
    public partial class m2a1 : Form
    {
        ...
        private void m2a1_Load(object sender, EventArgs e)
        {
           //textBox3.Text = _pathname2;
           //textBox3.Text = _pathname3;
           textBox3.Text = _pathname1;
             ...
             void Receving()
        {
            ...
            try
            {
                ...
                MessageBox.Show("Packet  Received From Server", "Key ACK", MessageBoxButtons.OK, MessageBoxIcon.Information);
...
private void button3_Click_1(object sender, EventArgs e)
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.InitialDirectory = @"C:\OUT_Cloud\Server_Cloud\micro1\" + textBox1.Text;
        ...
        public string _pathname12 { get; set; }
    }
}
